          ...
          {healthTimeline.length > 0 ? (
            <ResponsiveContainer width="100%" height={280}>
              <LineChart data={healthTimeline} margin={{ top: 8, right: 16, left: 4, bottom: 8 }}>
                ...
                <Line yAxisId="percent" type="monotone" dataKey="cpuUsagePercent" name="CPU %" stroke={chartPalette.cpu} strokeWidth={2.5} dot={{ r: 3 }} activeDot={{ r: 5 }} />
                <Line yAxisId="percent" type="monotone" dataKey="memoryUsagePercent" name="Memory %" stroke={chartPalette.memory} strokeWidth={2.5} dot={{ r: 3 }} activeDot={{ r: 5 }} />
                <Line yAxisId="network" type="monotone" dataKey="networkUplinkMbps" name="Uplink Mbps" stroke={chartPalette.network} strokeWidth={2.5} dot={{ r: 3 }} activeDot={{ r: 5 }} />
                <Line yAxisId="network" type="monotone" dataKey="alertCount" name="Alerts" stroke={chartPalette.alerts} strokeWidth={2} strokeDasharray="6 4" dot={{ r: 2.5 }} activeDot={{ r: 4 }} />
              </LineChart>
            </ResponsiveContainer>
          ) : (
            <div className="flex items-center justify-center h-[200px] text-muted-foreground text-sm">
              <div className="text-center">
                ...
                <p>Telemetry timeline is temporarily unavailable.</p>
              </div>
            </div>
          )}
          </CardContent>
