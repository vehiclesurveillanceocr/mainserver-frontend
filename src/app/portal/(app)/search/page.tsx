    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          title={filteredRows.length ? "Export hook can be added later" : "No filtered rows to export"}
      ...
      <Card className="glass overflow-hidden">
            ...
            <tbody>
              {filteredRows.map((row) => (
                <tr key={row.id} className="border-b border-border/60 last:border-0">
                  <td className="px-4 py-3 font-semibold text-foreground">{row.plate}</td>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-muted-foreground">{row.workstationDeviceId}</span>
                    </div>
                  </td>
                  <td className="px-4 py-3">
                  ...
                  <td className="px-4 py-3">
                    ...
                    >
                      {row.snapshotUrl ? "Available" : "Pending"}
                    </span>
                  </td>
                </tr>
              ))}
        ...
        {filteredRows.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h3 className="text-foreground font-medium mb-1">No Detections Match These Filters</h3>
            <p className="text-sm text-muted-foreground max-w-sm">
              Adjust the date, confidence, country, or plate search to reveal the mock detections.
            </p>
          </div>
        )}
      </Card>
