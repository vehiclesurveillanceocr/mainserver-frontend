...
const MOCK_TEXT_AR: Record<string, string> = {
  ...
  "Hitlist Vehicles": "مركبات القائمة",
  "Priority vehicles flagged for interception": "مركبات ذات أولوية تم تمييزها للاعتراض",
  "Border Watch": "مراقبة الحدود",
  "Vehicles flagged at interstate checkpoints": "مركبات تم تمييزها عند نقاط التفتيش بين الولايات",
  "Stolen Vehicles": "مركبات مسروقة",
  "Confirmed stolen vehicle records under investigation": "سجلات مركبات مسروقة مؤكدة قيد التحقيق",
  "Financial Crimes": "جرائم مالية",
  "Vehicles linked to financial crime investigations": "مركبات مرتبطة بتحقيقات الجرائم المالية",
  "Surveillance Queue": "قائمة المراقبة الميدانية",
  "Recurring sightings requested for field surveillance teams": "تم طلب رصد متكرر لفرق المراقبة الميدانية",
  "Regional Escalations": "تصعيدات إقليمية",
  "Escalated cases shared across regional control rooms": "حالات مصعدة تمت مشاركتها عبر غرف التحكم الإقليمية",
  "Initial import": "الاستيراد الأولي",
  "Cross-border monitoring list": "قائمة مراقبة عابرة للحدود",
  "Recovered theft cases synced from CID records": "حالات سرقة مستردة تمت مزامنتها من سجلات إدارة التحقيقات الجنائية",
  "Accounts under fraud review": "حسابات قيد مراجعة الاحتيال",
  "Priority observation requests from field intelligence": "طلبات مراقبة ذات أولوية من الاستخبارات الميدانية",
  "Regional escalation intake": "استقبال التصعيدات الإقليمية",
  "Hitlist vehicle detected": "تم اكتشاف مركبة في القائمة",
  "Border watch vehicle detected": "تم اكتشاف مركبة ضمن مراقبة الحدود",
  "Stolen vehicle detection": "تم اكتشاف مركبة مسروقة",
  "Fraud-linked vehicle detection": "تم اكتشاف مركبة مرتبطة بالاحتيال",
  "Surveillance request vehicle detected": "تم اكتشاف مركبة مطلوبة للمراقبة",
  "Regional escalation vehicle detected": "تم اكتشاف مركبة ضمن تصعيد إقليمي",
  "City Police": "شرطة المدينة",
  "Regional Task Force": "قوة المهام الإقليمية",
  "Border Security Unit": "وحدة أمن الحدود",
  "Criminal Investigation Department": "إدارة التحقيقات الجنائية",
  "Economic Offences Wing": "وحدة الجرائم الاقتصادية",
  "Field Intelligence Bureau": "مكتب الاستخبارات الميدانية",
  "Regional Command Center": "مركز القيادة الإقليمي",
...
const store: MockStoreState = {
  ...
  hitlists: [
    ...
    },
    {
      id: "hitlist-2",
      name: "Border Watch",
      description: "Vehicles flagged at interstate checkpoints",
      status: "ACTIVE",
      currentVersionNumber: 1,
      createdAt: iso(-1000 * 60 * 60 * 72),
      updatedAt: iso(-1000 * 60 * 95),
      versions: [
        {
          id: "version-2",
          versionNumber: 1,
          note: "Cross-border monitoring list",
          createdAt: iso(-1000 * 60 * 60 * 72),
          entries: [
            {
              id: "entry-3",
              plateOriginal: "MH12EF9012",
              plateNormalized: "MH12EF9012",
              countryOrRegion: "IN",
              priority: "HIGH",
              status: "active",
              reasonSummary: "Regional escalation vehicle detected",
              caseReference: "CASE-1003",
              sourceAgency: "Regional Command Center",
              vehicleMake: "Hyundai",
              vehicleModel: "Creta",
              vehicleColor: "Silver",
              createdAt: iso(-1000 * 60 * 60 * 72),
            ...
            {
              id: "entry-5",
              plateOriginal: "RJ14KL7788",
              plateNormalized: "RJ14KL7788",
              countryOrRegion: "IN",
              priority: "MEDIUM",
              status: "active",
              reasonSummary: "Border watch vehicle detected",
              caseReference: "CASE-1101",
              sourceAgency: "Border Security Unit",
    ...
    },
    {
      ...
      description: "Confirmed stolen vehicle records under investigation",
      status: "ACTIVE",
      currentVersionNumber: 1,
      createdAt: iso(-1000 * 60 * 60 * 96),
      updatedAt: iso(-1000 * 60 * 160),
      versions: [
        {
          id: "version-3",
          versionNumber: 1,
          note: "Recovered theft cases synced from CID records",
          createdAt: iso(-1000 * 60 * 60 * 96),
          entries: [
            {
              id: "entry-4",
              plateOriginal: "DL04GH3456",
              plateNormalized: "DL04GH3456",
              countryOrRegion: "IN",
              priority: "LOW",
              status: "active",
              reasonSummary: "Stolen vehicle detection",
              caseReference: "CASE-1004",
              sourceAgency: "Criminal Investigation Department",
              vehicleMake: "Maruti",
              vehicleModel: "Baleno",
              vehicleColor: "Blue",
              createdAt: iso(-1000 * 60 * 60 * 96),
            ...
            {
              id: "entry-6",
              plateOriginal: "UP32ZX4401",
              plateNormalized: "UP32ZX4401",
              countryOrRegion: "IN",
              priority: "HIGH",
              status: "active",
              reasonSummary: "Stolen vehicle detection",
              caseReference: "CASE-1102",
              sourceAgency: "Criminal Investigation Department",
              vehicleMake: "Honda",
              vehicleModel: "City",
              vehicleColor: "Red",
    ...
    },
    {
      ...
      description: "Vehicles linked to financial crime investigations",
      status: "DRAFT",
      currentVersionNumber: 1,
      createdAt: iso(-1000 * 60 * 60 * 120),
      updatedAt: iso(-1000 * 60 * 200),
      versions: [
        {
          id: "version-4",
          versionNumber: 1,
          note: "Accounts under fraud review",
          createdAt: iso(-1000 * 60 * 60 * 120),
          entries: [
            {
              id: "entry-7",
              plateOriginal: "GJ01QR2211",
              plateNormalized: "GJ01QR2211",
              countryOrRegion: "IN",
              priority: "MEDIUM",
              status: "active",
              reasonSummary: "Fraud-linked vehicle detection",
              caseReference: "CASE-1103",
              sourceAgency: "Economic Offences Wing",
              vehicleMake: "Toyota",
              vehicleModel: "Innova",
              vehicleColor: "Black",
              createdAt: iso(-1000 * 60 * 60 * 120),
            ...
            {
              id: "entry-8",
              plateOriginal: "WB20LM5510",
              plateNormalized: "WB20LM5510",
              countryOrRegion: "IN",
              priority: "LOW",
              status: "active",
              reasonSummary: "Fraud-linked vehicle detection",
              caseReference: "CASE-1104",
              sourceAgency: "Economic Offences Wing",
              vehicleMake: "Hyundai",
              vehicleModel: "Creta",
              vehicleColor: "Grey",
    ...
    {
      id: "hitlist-5",
      name: "Surveillance Queue",
      description: "Recurring sightings requested for field surveillance teams",
      status: "ARCHIVED",
      currentVersionNumber: 1,
      createdAt: iso(-1000 * 60 * 60 * 144),
      updatedAt: iso(-1000 * 60 * 240),
      versions: [
        {
          id: "version-5",
          versionNumber: 1,
          note: "Priority observation requests from field intelligence",
          createdAt: iso(-1000 * 60 * 60 * 144),
          entries: [
            {
              id: "entry-9",
              plateOriginal: "AP09ST6642",
              plateNormalized: "AP09ST6642",
              countryOrRegion: "IN",
              priority: "MEDIUM",
              status: "active",
              reasonSummary: "Surveillance request vehicle detected",
              caseReference: "CASE-1105",
              sourceAgency: "Field Intelligence Bureau",
              vehicleMake: "Mahindra",
              vehicleModel: "Bolero",
              vehicleColor: "Brown",
              createdAt: iso(-1000 * 60 * 60 * 144),
            ...
            {
              id: "entry-10",
              plateOriginal: "PB10UV9921",
              plateNormalized: "PB10UV9921",
              countryOrRegion: "IN",
              priority: "LOW",
              status: "active",
              reasonSummary: "Surveillance request vehicle detected",
              caseReference: "CASE-1106",
              sourceAgency: "Field Intelligence Bureau",
              vehicleMake: "Maruti",
              vehicleModel: "Baleno",
              vehicleColor: "Green",
